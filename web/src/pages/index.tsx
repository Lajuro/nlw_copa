...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      let poolResponse = await api.post("/pools", { title: poolTitle });
  ...
  const { poolCount = 0, guessCount = 0, userCount = 0 } = props;
      ...
      <main>
        ...
        <div className="mt-10 pt-10 border-t border-gray-600 flex justify-between items-center text-gray-100">
          <div className="flex items-center gap-6">
            <Image
              src={iconCheckImage}
              alt="Ícone de checkmark na cor verde"
              quality={100}
            />
...
/*
!# Use getStaticProps in order to make the app more performative
